        ...
        {THEMES.map((theme) => {
          ...
          return (
            ...
            >
              ...
              {/* Theme name and cost */}
              <div>
                <h3 className="font-serif text-sm font-medium text-theme-text">
                  {theme.name}
                </h3>
              ...
              {/* Action button */}
              {active ? (
                <div className="text-xs font-medium text-theme-accent px-3 py-1.5 rounded-xl bg-theme-accent/10 text-center">
                  Active
                </div>
              ) : owned ? (
                <button
                  onClick={() => switchTheme(theme.id)}
                  className="w-full glass rounded-xl px-4 py-2 shadow-glass text-xs font-medium text-theme-text hover:scale-[1.01] transition-transform"
                >
                  Apply
                </button>
              ) : (
                <button
                  ...
                  disabled={!canAfford}
                  className="w-full glass rounded-xl px-4 py-2 shadow-glass text-xs font-medium text-theme-text hover:scale-[1.01] transition-transform disabled:opacity-40 disabled:hover:scale-100"
                >
